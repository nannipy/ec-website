...
function SheetContent({
  ...
  return (
    <SheetPortal>
      ...
      >
        {children}
        <SheetPrimitive.Close className="ring-offset-background focus:ring-ring absolute top-4 right-4 p-2 text-brand-orange hover:text-white hover:bg-brand-orange/20 transition-all opacity-100  focus:ring-offset-2 focus:outline-hidden disabled:pointer-events-none cursor-pointer">
          <XIcon className="size-6 text-brand-orange" strokeWidth={2.5} />

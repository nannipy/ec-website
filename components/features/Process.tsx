        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-[5px]">
          {steps.map((step, idx) => (
            <div key={idx} className="flex flex-col gap-[12px] group cursor-pointer">
              <div className="relative h-[458px] w-full flex items-center justify-center overflow-hidden">
                {step.number === "1" ? (
                  <>
                    <svg width="350" height="458" viewBox="0 0 350 458" fill="none" xmlns="http://www.w3.org/2000/svg" className="block group-hover:hidden transition-all duration-300">
                    ...
                    <svg width="350" height="458" viewBox="0 0 350 458" fill="none" xmlns="http://www.w3.org/2000/svg" className="hidden group-hover:block transition-all duration-300">
                      <path d="M349.01 345V458H0.01V345H118.01V159.81L79.91 197.91L0 118.01L118.01 0H231.01V345H349.01Z" fill="#FD3F1F"/>
                    </svg>
                  </>
                ) : step.number === "2" ? (
                  <>
                    <svg width="349" height="458" viewBox="0 0 349 458" fill="none" xmlns="http://www.w3.org/2000/svg" className="block group-hover:hidden transition-all duration-300">
                    ...
                    <svg width="349" height="458" viewBox="0 0 349 458" fill="none" xmlns="http://www.w3.org/2000/svg" className="hidden group-hover:block transition-all duration-300">
              ...
              <div className="flex flex-col gap-[12px]">
                <p className="font-sans text-[12px] leading-[12px] text-white uppercase max-w-[349px] transition-colors duration-300 group-hover:text-[#FD3F1F]">
                  {step.title}
                </p>
                <div className="hidden group-hover:flex flex-col gap-[12px] transition-all duration-300">
                  {step.paragraphs.map((p, pIdx) => (
                    <p key={pIdx} className="font-sans text-[12px] leading-[12px] text-[#E3E3E3] max-w-[298px]">
                      {p}
                    </p>
                  ))}
                </div>
